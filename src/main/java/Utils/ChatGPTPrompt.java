...
public class ChatGPTPrompt {
    public static String getPrompt(List<String> palavras){
        return "I will give you a list of words in English, and I want you to do the following to each word:" +
                ...
                "}END" +
                ".But instead of using one simple quote, use double quotes, please"+
                "Here are the words:'" +
                palavras +
                "PS: The word END at the end of each json is important to me for parsing, so don't skip it. And I encourage you to make" +
